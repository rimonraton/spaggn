        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="#" class="flex items-center">
                    ...
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Good Give
                        Work</span>
                </a>
                ...
                <div :class="openMenu ? '' : 'hidden'"
                    class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <router-link :to="{ name: 'welcome' }"
                                class="block py-2 pl-3 pr-4 text-gray-700 lg:bg-transparent lg:p-0" aria-current="page">
                                Home</router-link>
                        </li>
                        <li>
