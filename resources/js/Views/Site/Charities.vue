...
<!--                        </svg>-->
                        <img src="/images/charity/trust.png" alt="Trust">
                    </div>
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Trust</h2>
                        <p class="leading-relaxed text-base">
                            Prove the donors that their donation is making a difference.
                        </p>
                    </div>
                </div>
                <div class="p-4 md:w-1/4 flex flex-col text-center items-center">
                    <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
                        <img src="/images/charity/altruism.png" alt="Trust">
                    </div>
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Altruism</h2>
                        <p class="leading-relaxed text-base">
                            Help the donors believe that it is important to help others.
                        </p>
                    </div>
                </div>
                <div class="p-4 md:w-1/4 flex flex-col text-center items-center">
                    <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
                        <img src="/images/charity/social.png" alt="Trust">
                    </div>
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Social</h2>
                        <p class="leading-relaxed text-base">
                            Show the donors that their donations matter to someone they know or care about.
                        </p>
                    </div>
                </div>
                <div class="p-4 md:w-1/4 flex flex-col text-center items-center">
                    <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
                        <img src="/images/charity/egoism.png" alt="Trust">
                    </div>
                    <div class="flex-grow">
                        <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Egoism</h2>
                        <p class="leading-relaxed text-base">
                            Make them feel good about themselves or look good to others.
                        </p>
                    </div>
                </div>
            </div>
            <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center mt-16">
                <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4 ">It’s about how you make them feel</h1>
                ...
                <div class="text-gray-500 mt-8">
                    ...
                    <p class="py-3 text-left">
                        ...
                        donors are not effective anymore. Instead, what if the donor receives an NFT? – a personal one-of-a-kind gift.
                    </p>
                    <p class="py-3 text-left">
                        The donor can hold on to the NFT and pass it to their children (just like a piece of art) or can sell
                        it at a higher price and raise more money for the charity.  With a royalty option attached to the NFT,
                        this will be a gift that will keep giving.
                    </p>
                </div>
                <div class="text-gray-500 mt-8">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4 text-left">When one is more than many</h1>
                    <p class="py-3 text-left">
...
<!--            <h2 class="text-2xl text-gray-900 font-bold md:text-4xl py-4">Charities</h2>-->
