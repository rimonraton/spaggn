<template>
    <div class="white" v-if="charityValue.length > 0">
                        ...
                        <div class="shadow p-4 rounded-lg bg-white">
                            <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                                <div
                                    ...
                                    <img class="w-full h-64 rounded-md transition hover:bg-cyan-300" :src="charity.cover_photo"
                                        alt="">
                                    <!-- </div> -->
                                </div>
                            </div>
