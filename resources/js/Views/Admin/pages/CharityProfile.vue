<template>
    <main>
        ...
        <div v-if="profile != null">
            ...
            <div v-else>
                <div
                    class="container p-6 mx-auto mt-8 md:mt-0 md:space-x-10 flex flex-col md:flex-row justify-center items-center md:py-10">
                    <div class="">
                        <img class="lg:h-80 md:h-64 h-40 rounded-lg" :src="imageUrl(profile.charityprofile.logo)"
                            alt="" />
                    </div>
                    <div class="mt-8 md:mt-0">
                        <h1 class="text-4xl text-gray-800 text-center md:text-left font-bold mb-6">Hi, we are
                            {{ profile.charityprofile.organization_name }}</h1>
                ...
                <div class="p-8 bg-white shadow">
                    ...
                    <div class="flex items-center justify-center p-10 bg-white">
                        <div class="container grid max-w-screen-xl gap-8 lg:grid-cols-2 lg:grid-rows-2">
                            ...
                            <div class="flex rounded-md border border-slate-200">
                                <div class="flex-1 p-10">
                                    <h3 class="text-xl font-medium text-gray-700"> Your organization’s link for
                                        GuideStar
                                    </h3>
                                    <p class="mt-2 text-slate-500">
