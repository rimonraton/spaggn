        ...
        <div v-if="showModal"
            ...
            <div class="relative w-full my-6 mx-auto max-w-6xl">
                ...
                <div
                    ...
                    <!--footer-->
                    <div v-if="bottomCloseButton || bottomSubmitButton" class="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                        <button
...
defineProps({
    ...
    bottomSubmitButton: { type: Boolean, default: false },
