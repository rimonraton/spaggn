<template>
    <main>
        ...
        <div v-if="hasProfile">
            <div
                class="w-full h-96 z-50 overflow-hidden bg-gray-300 opacity-75 flex flex-col items-center justify-center">
                    ...
                    <section class="bg-white dark:bg-gray-900">
                        <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
                            ...
                            <div class="flex flex-col items-center xl:items-start xl:w-1/2">
                                ...
                                <div class="mb-4">
                                    <img :src="imageUrl(profile.profile.cover)" class="max-w-full h-auto rounded-lg"
                                        alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    <div>
                                        ...
                                        <div class="grid gap-8 md:grid-rows-2 lg:grid-cols-2">
                                            <div
                                                ...
                                                <div class="h-full flex flex-col justify-center space-y-4">
                                                    <div>
                                                        <h6 class="text-lg font-semibold leading-none">Personal Story
                                                        </h6>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                                                    <div>
                                                        <h6 class="text-lg font-semibold leading-none">Message for world
                                                        </h6>
                                                    </div>
                        ...
                        <div class="bg-white shadow rounded-lg mb-6">
                            ...
                            <div class="text-gray-400 font-medium text-sm mb-7 mt-6 mx-3 px-2 pb-4"
                                v-if="profileAsset.length > 0">
                                <div class="grid grid-cols-6 col-span-2 gap-2">
                                    <div class="overflow-hidden rounded-xl col-span-3 max-h-[14rem]"
                                        v-for="asset in profileAsset" :key="asset">
