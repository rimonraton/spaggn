<template>
    ...
    <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
      <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        <a href="#" class="flex items-center">
          ...
          <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Good Give Work</span>
        </a>
        <div class="flex items-center gap-1 lg:order-2">
          ...
          <button @click="openMenu = !openMenu" data-collapse-toggle="mobile-menu-2" type="button"
            ...
            <svg v-if="!openMenu" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
  ...
  <section>
          ...
          <div class="max-w-sm bg-white rounded-lg dark:bg-gray-800">
            <div class="p-5 text-center">
              ...
              <form action="#">
                <div class="mt-4">
                  <input
                    class="block w-full px-4 py-2 text-gray-700 placeholder-gray-400 bg-white border rounded-md dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-500 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:ring-blue-300 focus:outline-none focus:ring"
                    type="email" placeholder="Email address" aria-label="Email address">
                  <input
                    class="block w-full px-4 py-2 mt-4 text-gray-700 placeholder-gray-400 bg-white border rounded-md dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-500 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:ring-blue-300 focus:outline-none focus:ring"
    ...
    <!-- <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
      <div class="mr-auto place-self-center lg:col-span-7">
        <h5
          class="max-w-2xl mb-4 text-xl font-extrabold leading-none tracking-tight md:text-2xl xl:text-4xl dark:text-white">
        ...
        <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
          <a href=""
            class="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-blue-200 rounded-lg sm:w-auto hover:border-blue-400 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
            Explore
          </a>
          <a href=""
            class="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white border border-purple-200 rounded-lg sm:w-auto focus:outline-none hover:border-purple-400 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
            Submit Project
          </a>
        </div>
      </div>
        ...
        <div id="accordion-flush" data-accordion="collapse"
          ...
          <h3 id="accordion-flush-heading-1">
            <button type="button"
              ...
              <span>Can I use Landwind in open-source
                projects?</span>
          ...
          <div id="accordion-flush-body-1" class="" aria-labelledby="accordion-flush-heading-1">
            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
              ...
              <p class="text-gray-500 dark:text-gray-400">
                ...
                <a href="#" class="text-purple-600 dark:text-purple-500 hover:underline">get started</a>
          ...
          <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
              <p class="mb-2 text-gray-500 dark:text-gray-400">
                Landwind is first conceptualized and designed
              ...
              <p class="text-gray-500 dark:text-gray-400">
                Check out the
                <a href="#" class="text-purple-600 dark:text-purple-500 hover:underline">Figma design system</a>
          ...
          <h3 id="accordion-flush-heading-3">
            <button type="button"
              ...
              <span>What are the differences between Landwind and
                Tailwind UI?</span>
              <svg data-accordion-icon="" class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
          ...
          <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
              ...
              <ul class="pl-5 text-gray-500 list-disc dark:text-gray-400">
                <li>
                  <a href="#" class="text-purple-600 dark:text-purple-500 hover:underline">Landwind Pro</a>
                </li>
                <li>
                  <a href="#" class="text-purple-600 dark:text-purple-500 hover:underline">Tailwind UI</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <footer class="bg-white dark:bg-gray-800">
    <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
      ...
      <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-4 text-center">
        <div>
        ...
        <div>
          ...
          <ul class="text-gray-500 dark:text-gray-400">
            <li class="mb-4">
              <a href="#" class="hover:underline">Art</a>
            </li>
            <li class="mb-4">
              <a href="#" class="hover:underline">Photography</a>
            </li>
            <li class="mb-4">
        ...
        <div>
          ...
          <ul class="text-gray-500 dark:text-gray-400">
            <li class="mb-4">
              <a href="#" class="hover:underline">Domains</a>
            </li>
            <li class="mb-4">
              <a href="#" class="hover:underline">DeFi</a>
            </li>
            <li class="mb-4">
              <a href="#" class="hover:underline">Metaverses</a>
            </li>
            <li class="mb-4">
              <a href="#" class="hover:underline">Memes</a>
            </li>
          </ul>
        </div>
        <div>
      ...
      <div class="text-center">
        <span class="block text-sm text-center text-gray-500 dark:text-gray-400">
          © {{ new Date().getFullYear() }} Good Giving Network. All
          Rights Reserved.
        </span>
