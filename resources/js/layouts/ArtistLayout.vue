<template>
        ...
        <div class="flex relative inline-block float-right">
          <div class="relative text-sm">
            ...
            <div id="userMenu" :class="dropdownOpen ? 'visible' : 'invisible'"
              ...
              <ul class="list-reset">
                <li>
                  <a href="#" class="px-4 py-2 block text-gray-900 hover:bg-gray-400 no-underline hover:no-underline">My
                    account</a>
                </li>
                <li>
                  <a href="#"
  ...
  <!-- <footer class="bg-white border-t border-gray-400 shadow fixed bottom-0 left-0 w-screen h-32">
